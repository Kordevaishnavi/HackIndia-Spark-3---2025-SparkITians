...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: "Tech-Stack Library",
        route: "/molecule-bank",
      },
      {
        icon: <SparkleIcon size={25} />,
        label: "Ai powered idea creator",
        route: "/model",
      },
      {
        icon: <SearchCheckIcon size={25} />,
        label: "Research",
        route: "/research",
      },
      {
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/">
            <div className="flex flex-row items-center justify-center space-x-2">
              ...
              <p className="text-xl font-semibold text-white">ResearchGenie</p>
            </div>
          </Link>
